...
class catalago : AppCompatActivity() {
    ...
    fun cargarSeries(){
        peliculas.add(Pelicula("Avatar: La leyenda de Aang",R.drawable.avatar, R.drawable.avatar, "La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la Nación del Fuego."))
        ...
        peliculas.add(Pelicula("El monstruo de la vieja Seul", R.drawable.elmonstruo, R.drawable.elmonstruovieja, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana."))
